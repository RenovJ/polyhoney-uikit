...
var Logo$2 = function () {
    return (React__default['default'].createElement("img", { alt: "HoneyFarmFinance", src: "/images/polyhoney/honeyfarm_dark.png", style: { width: "auto", height: "30px" } }));
};
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null,
        React__default['default'].createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React__default['default'].createElement(Icon$s, { width: "24px", color: "textMenu" })) : (React__default['default'].createElement(Icon$t, { width: "24px", color: "textMenu" }))),
