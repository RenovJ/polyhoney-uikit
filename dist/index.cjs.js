...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null,
        React__default['default'].createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React__default['default'].createElement(Icon$q, { width: "24px", color: "textMenu" })) : (React__default['default'].createElement(Icon$r, { width: "24px", color: "textMenu" }))),
