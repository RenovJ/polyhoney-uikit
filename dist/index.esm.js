...
var Logo = function (_a) {
    ...
    return (React.createElement(Flex, null,
        React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React.createElement(Icon$q, { width: "24px", color: "textMenu" })) : (React.createElement(Icon$r, { width: "24px", color: "textMenu" }))),
