...
var Wrapper$2 = styled(Flex)(templateObject_1$n || (templateObject_1$n = __makeTemplateObject(["\n  border-bottom: 2px solid ", ";\n  overflow-x: scroll;\n\n  ::-webkit-scrollbar {\n    display: none;\n  }\n  -ms-overflow-style: none; /* IE and Edge */\n  scrollbar-width: none; /* Firefox */\n"], ["\n  border-bottom: 2px solid ", ";\n  overflow-x: scroll;\n\n  ::-webkit-scrollbar {\n    display: none;\n  }\n  -ms-overflow-style: none; /* IE and Edge */\n  scrollbar-width: none; /* Firefox */\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.textSubtle;
});
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React.createElement(PriceLink, { href: "https://snowtrace.io/token/0xB669c71431bc4372140bC35Aa1962C4B980bA507", target: "_blank" },
        React.createElement(Icon$Z, { width: "24px", mr: "8px" }),
        React.createElement(Text, { color: "textMenu", bold: true }, "$" + cakePriceUsd.toFixed(2)))) : (React.createElement(Skeleton, { width: 80, height: 24 }));
};
...
var Panel = function (props) {
    ...
    return (React.createElement(StyledPanel, { isPushed: isPushed, showMenu: showMenu },
        ...
        React.createElement(Banner, { isPushed: isPushed },
            React.createElement("a", { href: "https://avax.farmscan.io/address/0x757490104fd4c80195d3c56bee4dc7b1279ccc51", target: "_blank" },
                React.createElement("img", { src: "images/farmscan.png", width: "200" }))),
        React.createElement(Banner, { isPushed: isPushed },
            React.createElement("a", { href: "https://github.com/peckshield/publications/blob/master/audit_reports/PeckShield-Audit-Report-HoneyFarm-v1.0.pdf", target: "_blank" },
                React.createElement("img", { src: "images/audit.png", width: "200" }))),
...
var HoverImg = styled.img(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  transition: background-color 0.2s, opacity 0.2s;\n  &:hover:not(:disabled):not(.pancake-button--disabled):not(.pancake-button--disabled):not(:active) {\n    opacity: 0.65;\n  }\n"], ["\n  transition: background-color 0.2s, opacity 0.2s;\n  &:hover:not(:disabled):not(.pancake-button--disabled):not(.pancake-button--disabled):not(:active) {\n    opacity: 0.65;\n  }\n"])));
        ...
        React.createElement(StyledNav, { showMenu: showMenu },
            ...
            React.createElement(RightContainer, null,
                React.createElement(Flex, null,
                    React.createElement("div", null,
                        React.createElement(Flex, { mr: isMobile ? 10 : 24, onClick: function () { onPresentNetworkSelectModal(); } }, isMobile ? React.createElement(HoverImg, { width: 46, height: 46, src: "images/modal_avalanche_bt.png" }) : React.createElement(HoverImg, { width: 126, height: 46, src: "images/ic_aval_modal_BT.png" }))),
