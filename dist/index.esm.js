...
var Icon$Z = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React.createElement("image", { width: 90, height: 90, href: "images/honeybee/token.png" })));
};
...
var Icon$A = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 128 128" }, props),
        React.createElement("image", { width: "96", height: "96", href: "images/honeybee/token.png" })));
};
...
// 	}
// `;
var Container$3 = styled.div(templateObject_2$e || (templateObject_2$e = __makeTemplateObject(["\n  position: relative;\n"], ["\n  position: relative;\n"])));
var RotatingPancakeIcon = styled(Icon$A)(templateObject_3$8 || (templateObject_3$8 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate);
...
var Wrapper$3 = styled.div(templateObject_6$1 || (templateObject_6$1 = __makeTemplateObject(["\n  position: relative;\n  display: flex;\n  align-items: center;\n"], ["\n  position: relative;\n  display: flex;\n  align-items: center;\n"])));
...
var Wrapper$2 = styled(Flex)(templateObject_1$p || (templateObject_1$p = __makeTemplateObject(["\n  border-bottom: 2px solid ", ";\n  overflow-x: scroll;\n\n  ::-webkit-scrollbar {\n    display: none;\n  }\n  -ms-overflow-style: none; /* IE and Edge */\n  scrollbar-width: none; /* Firefox */\n"], ["\n  border-bottom: 2px solid ", ";\n  overflow-x: scroll;\n\n  ::-webkit-scrollbar {\n    display: none;\n  }\n  -ms-overflow-style: none; /* IE and Edge */\n  scrollbar-width: none; /* Firefox */\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.textSubtle;
});
...
var StyledTab = styled.button(templateObject_1$o || (templateObject_1$o = __makeTemplateObject(["\n  display: inline-flex;\n  justify-content: center;\n  cursor: pointer;\n  border: 0;\n  outline: 0;\n  flex-grow: 1;\n  padding: 8px;\n  border-radius: 16px 16px 0 0;\n  color: ", ";\n  background-color: ", ";\n\n  ", " {\n    flex-grow: 0;\n    padding: 8px 12px;\n  }\n"], ["\n  display: inline-flex;\n  justify-content: center;\n  cursor: pointer;\n  border: 0;\n  outline: 0;\n  flex-grow: 1;\n  padding: 8px;\n  border-radius: 16px 16px 0 0;\n  color: ", ";\n  background-color: ", ";\n\n  ", " {\n    flex-grow: 0;\n    padding: 8px 12px;\n  }\n"])), function (_a) {
    var theme = _a.theme, color = _a.color;
...
var Logo$2 = function () {
    return (React.createElement("img", { alt: "HoneyFarmFinance", src: "/images/honeybee/main_logo.png", style: { width: "auto", height: "60px" } }));
};
...
var Icon$h = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "2 2 24 24" }, props),
...
var Logo = function (_a) {
    ...
    return (React.createElement(Flex, null,
        React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "12px", mt: "4px" }, isPushed ? (React.createElement(Icon$w, { width: "30px", color: "menuBackground" })) : (React.createElement(Icon$x, { width: "30px", color: "menuBackground" }))),
        isAbsoluteUrl ? (React.createElement(StyledLink, { as: "a", href: href, "aria-label": "Honeyfarm" }, innerLogo)) : (React.createElement(StyledLink, { to: href, "aria-label": "Honeyfarm" }, innerLogo))));
};
...
var StyledModal$1 = styled(Modal)(templateObject_1$d || (templateObject_1$d = __makeTemplateObject(["\n  border-radius : 15px;\n  border: 2px solid #DDC140;\n"], ["\n  border-radius : 15px;\n  border: 2px solid #DDC140;\n"])));
var StyledDiv$1 = styled.div(templateObject_2$5 || (templateObject_2$5 = __makeTemplateObject(["\n  border-radius : 15px;\n  border : 2px solid #DDC140;\n  fill : #272727;\n  width : ", ";\n  height : 355px;\n  display: flex;\n  justify-content: center;\n"], ["\n  border-radius : 15px;\n  border : 2px solid #DDC140;\n  fill : #272727;\n  width : ", ";\n  height : 355px;\n  display: flex;\n  justify-content: center;\n"])), function (_a) {
...
var ChangeNowModal = function (_a) {
    ...
    return (React.createElement(StyledModal$1, { title: "Multi Chain Swap", onDismiss: onDismiss },
        React.createElement(StyledDiv$1, { id: "iframe-widget-wrapper", isMobile: isMobile },
            React.createElement("iframe", { id: 'iframe-widget', src: 'https://changenow.io/embeds/exchange-widget/v2/widget.html?FAQ=true&amount=0.1&from=bnbbsc&horizontal=false&lang=en-US&link_id=9f59642593272a&locales=true&logo=true&to=bear', style: { height: "560px", width: "100%", border: "none" } }),
            React.createElement("script", { defer: true, type: 'text/javascript', src: 'https://changenow.io/embeds/exchange-widget/v2/stepper-connector.js' }))));
};
...
var PanelBody = function (_a) {
    ...
    var onPresentChangeNowModal = useModal(React.createElement(ChangeNowModal, null))[0];
    ...
    return (React.createElement(Container$1, null, links.map(function (entry) {
        ...
        if (entry.items) {
            ...
            var initialOpenState_1 = entry.initialOpenState === true
                ...
                : itemsMatchIndex >= 0;
            return (React.createElement(Accordion, { key: entry.label, isPushed: isPushed, pushNav: pushNav, icon: iconElement, label: entry.label, status: entry.status, initialOpenState: initialOpenState_1, className: calloutClass, isActive: entry.items.some(function (item) { return item.href === location.pathname; }) }, isPushed &&
                entry.items.map(function (item) {
                    if (item.items) {
                        var InnerIcon = Icons$1[item.icon];
                        var InnericonElement = React.createElement(InnerIcon, { width: "18px", mr: "4px", ml: "6px" });
                        return (React.createElement(Accordion, { key: item.label, isPushed: isPushed, pushNav: pushNav, icon: InnericonElement, label: item.label, status: item.status, initialOpenState: initialOpenState_1, className: calloutClass, isActive: item.items.some(function (item) { return item.href === location.pathname; }) }, isPushed &&
                            item.items.map(function (innerItem) {
                                return (React.createElement(MenuEntry, { key: innerItem.href, secondary: true, isActive: innerItem.href === location.pathname, onClick: handleClick },
                                    React.createElement(MenuLink, { href: innerItem.href, target: innerItem.target ? innerItem.target : "_self" },
                                        React.createElement(LinkLabelMemo, { isPushed: isPushed }, "　" + innerItem.label),
                                        innerItem.status && (React.createElement(LinkStatus, { color: innerItem.status.color, fontSize: "12px" }, innerItem.status.text)))));
                            })));
                    }
                    return (React.createElement(MenuEntry, { key: item.href, secondary: true, isActive: item.href === location.pathname, onClick: handleClick }, item.href === "changeNow" ? (React.createElement(MenuLink, { href: "#", onClick: function () {
                            onPresentChangeNowModal();
                        } },
                        React.createElement(LinkLabelMemo, { isPushed: isPushed }, item.label),
                        item.status && (React.createElement(LinkStatus, { color: item.status.color, fontSize: "14px" }, item.status.text)))) : (React.createElement(MenuLink, { href: item.href, target: item.target ? item.target : "_self" },
                        React.createElement(LinkLabelMemo, { isPushed: isPushed }, item.label),
                        item.status && (React.createElement(LinkStatus, { color: item.status.color, fontSize: "14px" }, item.status.text))))));
                })));
        }
        return (React.createElement(MenuEntry, { key: entry.label, isActive: entry.href === location.pathname, className: calloutClass },
            React.createElement(MenuLink, { href: entry.href, onClick: handleClick, target: entry.target ? entry.target : "_self" },
                iconElement,
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React.createElement(PriceLink, { href: "https://bscscan.com/address/0x1A8d7AC01d21991BF5249A3657C97b2B6d919222", target: "_blank" },
        React.createElement(Icon$Z, { width: "40px", mr: "8px" }),
        React.createElement(Text, { color: "textMenu", bold: true, fontSize: '20px' }, "$" + cakePriceUsd.toFixed(2)))) : (React.createElement(Skeleton, { width: 80, height: 24 }));
};
var CakePrice$1 = React.memo(CakePrice);
var templateObject_1$b;

var Icons = IconModule;
var SocialLinks = function () { return (React.createElement(Flex, { flexWrap: "wrap", ml: "10px" }, socials.map(function (social, index) {
    ...
    var HoverIcon = styled(Icon)(templateObject_1$a || (templateObject_1$a = __makeTemplateObject(["\n        transition: background-color 0.2s, opacity 0.2s;\n        &:hover:not(:disabled):not(.pancake-button--disabled):not(.pancake-button--disabled):not(:active) {\n          opacity: 0.65;\n        }\n      "], ["\n        transition: background-color 0.2s, opacity 0.2s;\n        &:hover:not(:disabled):not(.pancake-button--disabled):not(.pancake-button--disabled):not(:active) {\n          opacity: 0.65;\n        }\n      "])));
    var mr = index < socials.length - 1 ? "6px" : 0;
    if (social.items) {
        return (React.createElement("div", { key: social.label, style: { flex: "1 1 45%", paddingLeft: "9px" } },
            React.createElement(Dropdown, { key: social.label, position: "top", target: React.createElement(HoverIcon, __assign({}, iconProps, { mr: mr })) }, social.items.map(function (item) { return (React.createElement(Link, { external: true, key: item.label, href: item.href, "aria-label": item.label, color: "menuBackground" }, item.label)); }))));
    }
    return (React.createElement("div", { key: social.label, style: { flex: "1 1 45%", paddingLeft: "9px" } },
        React.createElement(Link, { external: true, href: social.href, "aria-label": social.label, mr: mr, pl: social.label == "Twitter" ? "2px" : "0px" },
            React.createElement(HoverIcon, __assign({}, iconProps)))));
}))); };
...
var BusybeeLinkContainer = styled.div(templateObject_1$8 || (templateObject_1$8 = __makeTemplateObject(["\n  margin-left: ", ";\n  margin-Right: ", ";\n  margin-bottom: 10px;\n"], ["\n  margin-left: ", ";\n  margin-Right: ", ";\n  margin-bottom: 10px;\n"])), function (_a) {
...
var Banner = styled.div(templateObject_3$2 || (templateObject_3$2 = __makeTemplateObject(["\n  margin-left: ", ";;\n  border-radius: 10px;  \n  transition: margin-left 0.2s; \n  transition: background-color 0.2s, opacity 0.2s;\n  &:hover:not(:disabled):not(.pancake-button--disabled):not(.pancake-button--disabled):not(:active) {\n    opacity: 0.65;\n  }\n"], ["\n  margin-left: ", ";;\n  border-radius: 10px;  \n  transition: margin-left 0.2s; \n  transition: background-color 0.2s, opacity 0.2s;\n  &:hover:not(:disabled):not(.pancake-button--disabled):not(.pancake-button--disabled):not(:active) {\n    opacity: 0.65;\n  }\n"])), function (_a) {
    var isPushed = _a.isPushed;
    return (isPushed ? "20px" : "0px");
});
var RoundedImage = styled.img(templateObject_4$2 || (templateObject_4$2 = __makeTemplateObject(["\n  border-radius: 8px;\n"], ["\n  border-radius: 8px;\n"])));
var BusybeeImage = styled.img(templateObject_5$2 || (templateObject_5$2 = __makeTemplateObject(["\n  border-radius: 22.85px;\n  box-shadow: 0px 4px 5px rgba(0, 0, 0, 0.15); \n  transition: background-color 0.2s, opacity 0.2s;\n  &:hover:not(:disabled):not(.pancake-button--disabled):not(.pancake-button--disabled):not(:active) {\n    opacity: 0.65;\n  }\n"], ["\n  border-radius: 22.85px;\n  box-shadow: 0px 4px 5px rgba(0, 0, 0, 0.15); \n  transition: background-color 0.2s, opacity 0.2s;\n  &:hover:not(:disabled):not(.pancake-button--disabled):not(.pancake-button--disabled):not(:active) {\n    opacity: 0.65;\n  }\n"])));
var Panel = function (props) {
    var isPushed = props.isPushed, showMenu = props.showMenu;
    useMatchBreakpoints().isXl;
    return (React.createElement(StyledPanel, { isPushed: isPushed, showMenu: showMenu },
        React.createElement(BusybeeLinkContainer, { isPushed: isPushed },
            React.createElement("a", { href: "https://busybee.honeyfarm.finance" },
                React.createElement(BusybeeImage, { height: "36px", src: "images/busybee_link2.png" }))),
        React.createElement(PanelBody, __assign({}, props)),
        React.createElement(Banner, { isPushed: isPushed },
            React.createElement("a", { href: "https://github.com/peckshield/publications/blob/master/audit_reports/PeckShield-Audit-Report-HoneyFarm-v1.0.pdf", target: "_blank" },
                React.createElement(RoundedImage, { src: "images/audit.png", width: "200" }))),
...
var UserBlock = function (_a) {
    ...
    return (React.createElement(Wrapper$1, null, account ? (React.createElement(Button, { scale: "sm", variant: "primary", onClick: function () {
...
var StyledModal = styled(Modal)(templateObject_1$4 || (templateObject_1$4 = __makeTemplateObject(["\n  border-radius : 15px;\n  border: 2px solid #DDC140;\n"], ["\n  border-radius : 15px;\n  border: 2px solid #DDC140;\n"])));
var StyledDiv = styled.div(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["\n  border-radius : 15px;\n  border : 2px solid #DDC140;\n  fill : #272727;\n  width : ", ";\n  height : ", ";\n  display: flex;\n  justify-content: center;\n  transition: background-color 0.2s, opacity 0.2s;\n  &:hover:not(:disabled):not(.pancake-button--disabled):not(.pancake-button--disabled):not(:active) {\n    opacity: 0.65;\n"], ["\n  border-radius : 15px;\n  border : 2px solid #DDC140;\n  fill : #272727;\n  width : ", ";\n  height : ", ";\n  display: flex;\n  justify-content: center;\n  transition: background-color 0.2s, opacity 0.2s;\n  &:hover:not(:disabled):not(.pancake-button--disabled):not(.pancake-button--disabled):not(:active) {\n    opacity: 0.65;\n"])), function (_a) {
    var isMobile = _a.isMobile;
...
var FlexBox = styled.div(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["\n  display: flex;\n  justify-content : space-between;\n  flex-direction : ", ";\n  width :  ", ";\n  ", "\n  margin: 10px 22px 15px 22px;\n"], ["\n  display: flex;\n  justify-content : space-between;\n  flex-direction : ", ";\n  width :  ", ";\n  ", "\n  margin: 10px 22px 15px 22px;\n"])), function (_a) {
    var isMobile = _a.isMobile;
...
var BSCImage = styled.img(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["\n  margin-top:  ", ";\n  width:", ";\n  height:", ";\n"], ["\n  margin-top:  ", ";\n  width:", ";\n  height:", ";\n"])), function (_a) {
    var isMobile = _a.isMobile;
...
var AVALImage = styled.img(templateObject_5$1 || (templateObject_5$1 = __makeTemplateObject(["\n  margin-top:  ", ";\n  width:", ";\n  height:", ";\n"], ["\n  margin-top:  ", ";\n  width:", ";\n  height:", ";\n"])), function (_a) {
    var isMobile = _a.isMobile;
    return (isMobile ? "54px;" : "44px");
}, function (_a) {
    var isMobile = _a.isMobile;
...
var NetworkSelectModal = function (_a) {
    ...
    var isXl = useMatchBreakpoints().isXl;
    var isMobile = isXl === false;
    return (React.createElement(StyledModal, { title: "Select a Network", onDismiss: onDismiss },
        React.createElement(FlexBox, { isMobile: isMobile },
            React.createElement(Link, { href: "https://bee.honeyfarm.finance", external: true },
                React.createElement(StyledDiv, { isMobile: isMobile },
                    React.createElement("div", null,
                        React.createElement(BSCImage, { src: "images/networkBSC.png", isMobile: isMobile })))),
            React.createElement(Link, { href: "https://avalanche.honeyfarm.finance/", external: true },
                React.createElement(StyledDiv, { isMobile: isMobile },
                    React.createElement("div", null,
                        React.createElement(AVALImage, { src: "images/networkAval.png", isMobile: isMobile })))))));
};
...
var HoverImg = styled.img(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  transition: background-color 0.2s, opacity 0.2s;\n  &:hover:not(:disabled):not(.pancake-button--disabled):not(.pancake-button--disabled):not(:active) {\n    opacity: 0.65;\n  }\n"], ["\n  transition: background-color 0.2s, opacity 0.2s;\n  &:hover:not(:disabled):not(.pancake-button--disabled):not(.pancake-button--disabled):not(:active) {\n    opacity: 0.65;\n  }\n"])));
var Menu = function (_a) {
    ...
    var onPresentNetworkSelectModal = useModal(React.createElement(NetworkSelectModal, null))[0];
    useEffect(function () {
    ...
    return (React.createElement(Wrapper, null,
        React.createElement(StyledNav, { showMenu: showMenu },
            ...
            React.createElement(Flex, null,
                React.createElement("div", null,
                    React.createElement(Flex, { mr: isMobile ? 10 : 24, width: isMobile ? 46 : 109, height: 46, onClick: function () {
                            onPresentNetworkSelectModal();
                        } }, isMobile ? (React.createElement(HoverImg, { width: 46, height: 46, src: "images/modal_bsc_bt.png" })) : (React.createElement(HoverImg, { width: 109, height: 46, src: "images/ic_bsc_modal_BT.png" })))),
